...
BEGIN
    ...
    BEGIN TRY
        ...
        PRINT '------------';
        PRINT '';
    --Loading crm table silver.crm_sales_details
        SET @start_time = GETDATE();
        ...
        PRINT '---------';
        PRINT '';
        --Loading erp table silver.erp_cust_az12
        SET @start_time =GETDATE();
        ...
        PRINT '--------';
        PRINT '';
        --Loading erp table silver.erp_loc_a101
        SET @start_time = GETDATE();
        ...
        PRINT '-------';
        PRINT '';
        --Loading erp silver.erp_px_cat_g1v2
        SET @start_time = GETDATE();
